# src/pipeline/prices/sbs/rf_local/transform.py
import logging
import pandas as pd
...
FACT_FIELD_MAP = {
    ...
    "interes_corrido_monto": "ACCRUED_INT", "tir": "YTM", "spreads": "SPREAD",
    "tir_sin_opciones": "YTW", "duracion": "DURATION",
    "variacion_precio_limpio": "CHG_CLEAN", "variacion_precio_sucio": "CHG_DIRTY",
...
DIM_BOND_MAP = {
    ...
    "margen_libor": "libor_margin", "rating": "credit_rating",
...
def transform(stg_df, securities):
    ...
    logger.info(f"rf_local transform: {len(facts_df)} fact rows, {len(dims_df)} dim rows.")
